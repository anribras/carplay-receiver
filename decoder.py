...
#        def run(self):
#             player = mpv.MPV(log_handler=self.owner.log, input_default_bindings=False, input_vo_keyboard=True,
#                              hwdec="rpi", demuxer_rawvideo_fps=60, fps=60)
